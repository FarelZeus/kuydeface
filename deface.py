...
mess = """===============================================
            Author  : Tn.FarelZeus      
            Team    : LPG ATTACKER TEAM
	    WhatsApp : 081377804838
	    Youtube : ZeusGTPS
==============================================="""

print mess
print "Created By Tn.FarelZeus"
print "Recode by Tn.FarelZeus"
title = raw_input("Judul title nya cok: ")
heading = raw_input("Hacked by siapa cok: ")
